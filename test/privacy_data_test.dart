...
void main() {
  test('wipeAllLocalData clears tracked data but keeps device identity', () async {
    ...
    await db
        .into(db.trips)
        .insert(
          TripsCompanion.insert(startedAt: DateTime.now(), source: RecordSource.location),
        );
  ...
  test(
    'a pending-upload location point survives closing and reopening the '
    'database file (process-death recovery — no queued data lost)',
    () async {
